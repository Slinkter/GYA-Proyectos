...
export default function ListadoItems({ productos, onUpdate, onRemove }: ListadoItemsProps) {
      ...
      <div className="grid gap-4">
        {productos.map((item) => (
          ...
          >
            ...
            <div className="w-24 h-24 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-center text-xs text-gray-400 font-bold uppercase tracking-tighter text-center p-2">
              JPG/SVG PREVIEW
            </div>
